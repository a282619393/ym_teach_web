<template>
  <div class="appraisal_record" v-loading.fullscreen="showReport">
    ...
    <div class="appraisal_top_box">
      <img src="../../assets/images/appraisal/answer-record.png" alt="logo" class="top_img" />
      <div class="top_botton">
        <!-- <div
          class="top_btn_report"
          @click="()=>this.$router.push('/teaching/appraisal_report/url')"
        >评测报告</div>-->
        <div class="top_btn_report" @click="EvaluationReport">评测报告</div>
        <div class="top_btn_record">答题记录</div>
      </div>
      ...
      <div class="top_bottom">
        ...
        <p class="top_bottom_chinese">Alpha喵学前评测答题记录</p>
        <p class="top_bottom_english">Answer record</p>
    ...
    <div class="appraisal_main_box">
      ...
      <div class="main_white" ref="print">
        ...
        <div class="print" v-show="showReport">
          ...
          />
          <img src="../../assets/images/appraisal/logo.png" alt="logo" />
          <div class="print_china">Alpha喵学前答题记录</div>
          ...
          <li class="main_white_bottom" v-for="(item,index) in question" :key="index">
            ...
            >
              ...
              >
                <div class="flex ai">
                  <!-- 单选的图标 -->
                  <div v-if="item.questionItem.type==0">
                    <img
                  ...
                  <div v-else>
                    <img
                      src="../../assets/images/select--and-border.png"
                      alt="logo"
                      v-if="!item.questionItem.rightKey.split('').includes(options.name.substr(2))"
                    />
    ...
    <!-- 返回顶部 -->
    <el-backtop target=".el-main" :right="200" :bottom="100" :visibility-height="1000">
      <div class="go_top">
        <span>TOP</span>
  ...
  methods: {
    EvaluationReport() {
      ...
      this.$router.push({
        ...
        query: {
          courseId: evaluatingData.courseId,
          studentId: evaluatingData.studentId
        }
      });
    },
    init(right) {
    ...
    showErr() {
      ...
      sessionStorage.setItem("showRight", this.showRight);
    },

    //点击打印报告
    print() {
      this.showReport = true;
      this.$router.push("/print_record");
    }
  },
  computed: {},
  watch: {}
