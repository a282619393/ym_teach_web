<template>
  <div class="share_record" v-loading.fullscreen="showReport">
    <!-- 打印用的图片 -->
      ...
      <div class="main_white" ref="print">
        ...
        <div class="print" v-show="showReport">
          ...
          <ul class="print_bottom">
            ...
            <li>
              <span>测试用时：</span>
              <span v-html="delTime(top.time)"></span>
            </li>
          </ul>
        </div>
        <!-- 白色背景部分 -->
    ...
    <!-- 返回顶部 -->
    <el-backtop :right="200" :bottom="100" :visibility-height="1000">
      <div class="go_top">
        <span>TOP</span>
...
export default {
  ...
  methods: {
    ...
    init(right) {
      let course = JSON.parse(sessionStorage.getItem("evaluation"));
      ...
      getEvaluateRecord(
        ...
        .then(res => {
          this.top["name"] = this.$route.query.name;
          this.top["course"] = this.$route.query.course;
          this.top["endTime"] = this.$route.query.endTime;
          this.top["time"] = this.$route.query.time;
          this.renderData = res;
