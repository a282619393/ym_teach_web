  ...
  <div class="appraisal_report" v-loading.fullscreen="showReport" ref='printHing'>
    ...
    <div class="appraisal_top_box">
      ...
      <div class="top_botton">
        ...
        <!-- <div
          class="top_btn_record"
          @click="()=>this.$router.push('/teaching/appraisal_record')"
        >答题记录</div>-->
    ...
    <!-- 返回顶部 -->
    <el-backtop target=".el-main" :right="220" :bottom="170" :visibility-height="1300">
      <div class="go_top">
        <span>TOP</span>
...
export default {
  ...
  methods: {
    ...
    print() {
      ...
      //       document.getElementsByTagName('body')[0].style.width=ww;
